...
const About = () => {
    ...
    return (
        <section
            id="about"
            className="relative w-full shadow-lg hover:shadow-2xl transition-shadow
                 dark:bg-typography bg-typography-dark rounded-3xl text-center
                 text-typography dark:text-typography-dark"
        >
            <div className="container py-8 lg:flex flex-col gap-6">
                <svg viewBox="0 0 973.59 276.47" className="w-full text-black dark:text-white" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <style>
                            {`
                  .cls-1 { fill: red; }
