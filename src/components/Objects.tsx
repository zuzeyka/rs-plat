...
const Objects = () => {
    ...
    return (
        <section id="objects" className="w-full mx-auto border-b-4 border-primary py-20 text-center text-typography">
            ...
            <div className="grid md:grid-cols-3 gap-6">
                {objects.map((object, index) => (
                    <motion.div
                        ...
                        whileHover="hover"
                    >
                        <h3 className="relative lg:absolute top-64 -left-36 text-typography text-xl font-bold transform -rotate-90 lg:opacity-0 whitespace-nowrap">
                            {object.title}
                        </h3>
                        ...
                        <motion.div className="absolute inset-0 bg-black bg-opacity-50" variants={overlayVariants} transition={{ duration: 0.5 }}>
                            <h3 className="relative top-60 -left-36 text-typography text-xl font-bold transform -rotate-90">{object.title}</h3>
